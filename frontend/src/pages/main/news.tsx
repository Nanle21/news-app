...
import { useArticles, useBookmarkArticle, useCategories, useSources } from '../../hooks/useArticles';
...
export default function News() {
  ...
  // React Query for articles data with all filters
  ...
  const handleToggleBookmark = async (articleId: number) => {
    try {
      await bookmarkMutation.mutateAsync({ articleId, bookmarked: true });
      dispatch(
        showNotification({
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto">
        <Header title={t('navigation.news')} description={t('news.description')} />
          ...
          <>
            ...
            <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Showing {articles.length} of {articlesData?.total || 0} articles
                {hasActiveFilters && (
